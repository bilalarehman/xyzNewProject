...
MySQL - 5.5.5-10.1.28-MariaDB : Database - test
*********************************************************************
*/
...
insert  into `inf_app`(`APP_NAME`,`APP_LOGO`,`APP_VER`,`APP_DEV`,`APP_DEV_WEB`,`APP_CR`) values ('New Application','nil','2.1.5','I Tech Stellar','http://www.itechstellar.com','2018-2019');
...
insert  into `inf_main_menu`(`PMENUID`,`PMENUICON`,`PMENUNAME`,`PMENULINK`,`ALLOW_GROUP`,`ORDER_BY`,`ALLOW`) values (8,'fa fa-info-circle','Information Section','app','Admin,Fees Section',9,'Y'),(9,'fa fa-user','User Section','user','Admin',10,'Y'),(10,'fa fa-cog','Setting','options','Admin',11,'Y');
